...
window.addEventListener('load', function () {
  ...
  function tool_pencil () {
    ...
    this.mousedown = function (ev) {
        ...
        tool.started = true;
        socket.emit("paint",{data: "startPaint$%*!" + appConfig.roomid + "$%*!" + ev._x + "$%*!" + ev._y + "$%*!" + context.lineWidth + "$%*!" + context.strokeStyle}); // Sending to the server to start painting on viewers' side 
    };
